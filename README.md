...
# Communicable Diseases Surveillance Data Repository
...
## <span style="color:brown;font-weight:bold">DISEASE TRACKING AND MONITORING</span>
...
## <span style="color:brown">Information Resources</span>
...
## <span style="color:brown;font-weight:bold">PRIVACY AND SECURITY CONCERNS</span>
...
## <span style="color:brown;font-weight:bold">NAMING CONVENTION</span>
...
## <span style="color:brown">Abbreviations and Compound Words</span>
...
## <span style="color:brown;font-weight:bold">DATABASE DESIGN CONSIDERATIONS</span>
...
## <span style="color:brown">Database Schemas</span>
...
## <span style="color:brown">Tables</span>
...
## <span style="color:brown">Table Colums</span>
...
## <span style="color:brown">Code Sets</span>
...
## <span style="color:brown">Assocciations</span>
...
## <span style="color:brown">Non-identifying Relationships</span>
...
## <span style="color:brown">Documentation</span>
The Documentation folder contains:

| Document | Description |
| ------------------------- | --------------------------- |
| eci.hc.cd.dictionary.xlsx | Type based with qualified names data dictionary. |
| eci.hc.cd.lexicon.xlsx    | Vocabulary, Metadata, Terms, and other. |
| eci.hc.cd.schema.xlsx     | Extracted schema. |

## <span style="color:brown;font-weight:bold">ROAD MAP</span>
...
## <span style="color:brown;font-weight:bold">RESOURCES</span>
...
## <span style="color:brown;font-weight:bold">REFERENCE & LINKS</span>
[1] CDC Centers for Disease Control and Prevention -
    National Notifiable Diseases Surveillance System (NNDS) -
    https://www.cdc.gov/nndss/index.html

## <span style="color:brown;font-weight:bold">KNOWN ISSUES</span>
...
## <span style="color:brown;font-weight:bold">LAKEHOUSE CONNECTIVITY</span>
